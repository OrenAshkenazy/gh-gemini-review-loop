...
def format_pending_profile_block(repo: str) -> str:
    ...
    return (
        ...
        f"  fetch_gemini_threads.py --repo {repo} --profile-intro\n"
        f"  fetch_gemini_threads.py --repo {repo} --planned-verification"
    )
